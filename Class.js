...
try {
  ...
  Object.defineProperty(EventEmitter.prototype,'emit',{
    ...
    value: function(eventname,data){
      /*if (this.parent !== null){
        if (['Schema','Model'].indexOf(this.classType) < 0){
          console.log(this.parent,eventname,this.classType);
          if ((this.parent||{}) instanceof API.base){
            data = data || {};
            data.origin = this;
            this.parent.emitEvent('*',[{name:eventname,data:data||null}]);
          }
        }
      }*/
